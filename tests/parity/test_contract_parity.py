...
def test_checked_in_schemas_match_generation(tmp_path: Path) -> None:
    ...
    historical = {
        ...
        "MainRollbackCleanupObservation.v1.schema.json",
        "MainRollbackCleanupObservation.v2.schema.json",
        "MainRollbackCleanupReceipt.v1.schema.json",
        "MainRollbackCleanupReceipt.v2.schema.json",
        "MainRollbackCleanupIntent.v1.schema.json",
        "MainRollbackCleanupTerminalEvidence.v2.schema.json",
