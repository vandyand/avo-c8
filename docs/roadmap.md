...
| C6 — campaign runner and eligibility ledger | planned | Next ready gate after C5 offline acceptance; hosted ledger activation still requires blocked C8 prerequisites and a fresh hosted rollback drill. |
