...
- AVO-004.7 has begun on 2026-08-29. C1 contracts/journaling, C2 deterministic composition,
  ...
  assertions. Canonical hosted run
  [33688935928](https://github.com/vandyand/avo-c8/actions/runs/33688935928), on exact commit
  `2f35d65381774b83fdbe622539ef7185d2b465ff`, subsequently passed Ubuntu (2,600 passed, two
  skipped, 85.20% with the literal floor enforced) and Windows (2,589 passed, six skipped).
  Follow-on Terra-approved leaves `7dd0ba8` (read-only hosted-configuration diagnostic and
  isolated GitHub `main`-base reader; hosted run [33707053367](https://github.com/vandyand/avo-c8/actions/runs/33707053367)
  passed Ubuntu and Windows) and `ae4aaa8` (pure offline non-authoritative evidence composition;
  hosted run [33709514612](https://github.com/vandyand/avo-c8/actions/runs/33709514612) passed
  Ubuntu and Windows on exact `ae4aaa8242758e664d4acc2252579ff76999e2b0`) add evidence only.
  Commits `bbc4d827` and `2f35d653` enforce the unchanged floor and add meaningful adversarial
  coverage without excluding production files. Its fixed `PATCH` main operation uses `force=false`, exact B-to-C
